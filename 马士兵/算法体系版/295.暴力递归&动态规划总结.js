 ...
 * 面试题和动态规划的关系？
 * 解决一个问题，可能有很多尝试方法
 * 可能在尝试方法中，又有若干方法有动态规划的方式
 * 一个问题 可能有 若干种动态规划的解法
 * 
 * 
 * 
 * 如何找到某个问题的动态规划方式？
 * 设计暴力规划：重要原则+4种常见尝试模型！重点！
 * 分析有没有重复解：套路解决
 ...
 * ② 原则①可以违反，让类型突破到一维线性结构，那必须是单一可变参数
 * ③ 如果发现原则①被违反，但不违反原则②，只需要做到记忆化搜索即可
 * ④ 可变参数的个数，能少则少
 * 
 * 
 ...
 * 
 * 暴力递归到动态规划的套路
 * 你已经有了一个不违反原则的暴力递归，二期的确存在解的重复调用
